...
-- Update Paige Turner's store to Miami
UPDATE Salespersons
SET store = 'Miami'
WHERE staff_id = 5;
...
UPDATE Customers
SET email = 'ppicasso@gmail.com' WHERE customer_id = 1;
UPDATE Customers
SET email = 'lincoln@us.gov' WHERE customer_id = 2;
UPDATE Customers
SET email = 'hello@napoleon.me' WHERE customer_id = 3;
